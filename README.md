...
Also make sure you have the node module `babel-cli` installed globally. After that execute `gulp serve`, point your browser to http://localhost:3000 and start adding and editing files in `src`.
